...
(async () => {
    ...
    try {
        if (process.argv.length < 3) {
            throw new Error('Error: You need to pass either "all" or a relevant keyword to this setup script so that it knows which setup scripts to run. Ending script...');
        }
