...
module.exports = {
  ...
  "scenarios": [
    ...
    { "label": "harvest sources", "url": `${process.env.DOMAIN}/harvest` },
    { "label": "add new harvest source", "url": `${process.env.DOMAIN}/harvest/new` },
    { "label": "add new harvest source: form errors", "url": `${process.env.DOMAIN}/harvest/new`, "onReadyScript": "utils/form-errors.js" },
    { "label": "view harvest source datasets", "url": `${process.env.DOMAIN}/harvest/mock-harvest-source` },
    { "label": "view harvest source details", "url": `${process.env.DOMAIN}/harvest/about/mock-harvest-source` },
    { "label": "manage harvest source", "url": `${process.env.DOMAIN}/harvest/admin/mock-harvest-source` },
