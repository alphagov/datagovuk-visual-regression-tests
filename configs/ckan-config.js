module.exports = id => ({
    ...
    "scenarios": [
        ...
        { "label": "Harvest - last job report for source", "url": `${process.env.DOMAIN}/harvest/example-harvest-1/job/last`, "hideSelectors": [".gravatar", ".username", ".dataset-list"] },
        { "label": "Harvest - jobs list for source", "url": `${process.env.DOMAIN}/harvest/example-harvest-1/job`, "hideSelectors": [".gravatar", ".username"] },
        ...
        { "label": "User - view activity", "url": `${process.env.DOMAIN}/user/activity/default`, "hideSelectors": [".gravatar", ".username", "#flDebug", ".date"] },
