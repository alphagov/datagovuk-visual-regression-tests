module.exports = id => ({
    ...
    "scenarios": [
        ...
        { "label": "Publisher - add new", "url": `${process.env.DOMAIN}/${id === "ckan-2.9" ? "organization" : "publisher"}/new`, "uploadField": true, "slugPreview": true, "textarea": true },
        { "label": "Publisher - add new: form errors", "url": `${process.env.DOMAIN}/${id === "ckan-2.9" ? "organization" : "publisher"}/new`, "submitForm": true, "uploadField": true, "textarea": true },
        { "label": "Publisher - view publisher", "url": `${process.env.DOMAIN}/${id === "ckan-2.9" ? "organization" : "publisher"}/example-publisher-1` },
        { "label": "Publisher - edit publisher", "url": `${process.env.DOMAIN}/${id === "ckan-2.9" ? "organization" : "publisher"}/edit/example-publisher-1`, "uploadField": true, "slugPreview": true },
